...
/** CUP v0.11b beta 20140220 generated parser.
  * @version Sun Mar 24 19:51:57 CET 2024
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalizadorSintacticoTiny$act_num)
		...
		StringLocalizado lit_ent = (StringLocalizado)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.elementAt(CUP$AnalizadorSintacticoTiny$top-1)).value;
		 RESULT = sem.tipo_array(tipo, lit_ent);
          ...
          case 13: // tipo ::= tipo2 
            {
              Tipo RESULT =null;
		Location tipo2xleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xleft;
		Location tipo2xright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xright;
		Tipo tipo2 = (Tipo)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = tipo2;
		...
		Tipo tipo2 = (Tipo)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = sem.tipo_punt(tipo2);
          ...
          case 15: // tipo2 ::= tipo3 
            {
              Tipo RESULT =null;
		Location tipo3xleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xleft;
		Location tipo3xright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xright;
		Tipo tipo3 = (Tipo)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = tipo3;
          ...
          case 16: // tipo3 ::= BOOL 
            {
              Tipo RESULT =null;
		Location boolxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xleft;
		Location boolxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xright;
		Object bool = (Object)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT =sem.tipo_bool();
          ...
          case 17: // tipo3 ::= ENT 
            {
              Tipo RESULT =null;
		Location intxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xleft;
		Location intxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xright;
		Object int = (Object)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT =sem.tipo_int();
              CUP$AnalizadorSintacticoTiny$result = parser.getSymbolFactory().newSymbol("tipo3",8, ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), RESULT);
            }
          return CUP$AnalizadorSintacticoTiny$result;
          ...
          case 18: // tipo3 ::= REAL 
            {
              Tipo RESULT =null;
		Location realxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xleft;
		Location realxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xright;
		Object real = (Object)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT =sem.tipo_real();
          ...
          case 19: // tipo3 ::= STRING 
            {
              Tipo RESULT =null;
		Location stringxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xleft;
		Location stringxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$AnalizadorSintacticoTiny$stack.peek()).xright;
		Object string = (Object)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		...
		Exp exp1 = (Exp)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.elementAt(CUP$AnalizadorSintacticoTiny$top-1)).value;
		 RESULT = (Exp)sem.exp_index(exp,exp1); 
		...
		StringLocalizado iden = (StringLocalizado)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = (Exp)sem.exp_reg(exp,iden); 
		...
		Exp exp = (Exp)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = exp; 
          ...
          case 65: // E7 ::= TRUE 
            {
              Exp RESULT =null;
		 RESULT = (Exp)sem.exp_true("true").ponFila(num.fila()).ponCol(num.col()); 
          ...
          case 66: // E7 ::= FALSE 
            {
              Exp RESULT =null;
		 RESULT = (Exp)sem.exp_false("false").ponFila(num.fila()).ponCol(num.col()); 
              CUP$AnalizadorSintacticoTiny$result = parser.getSymbolFactory().newSymbol("E7",24, ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), RESULT);
            }
          return CUP$AnalizadorSintacticoTiny$result;
		...
		StringLocalizado cad = (StringLocalizado)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = (Exp)sem.exp_litCad(cad.str()).ponFila(num.fila()).ponCol(num.col()); 
              CUP$AnalizadorSintacticoTiny$result = parser.getSymbolFactory().newSymbol("E7",24, ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), RESULT);
            }
          return CUP$AnalizadorSintacticoTiny$result;
		...
		StringLocalizado id = (StringLocalizado)((java_cup.runtime.Symbol) CUP$AnalizadorSintacticoTiny$stack.peek()).value;
		 RESULT = (Exp)sem.exp_iden(id.str()).ponFila(id.fila()).ponCol(id.col()); 
          ...
          case 71: // E7 ::= NULL 
            {
              Exp RESULT =null;
		 RESULT = (Exp)sem.exp_null("null").ponFila(num.fila()).ponCol(num.col()); 
              CUP$AnalizadorSintacticoTiny$result = parser.getSymbolFactory().newSymbol("E7",24, ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalizadorSintacticoTiny$stack.peek()), RESULT);
            }
          return CUP$AnalizadorSintacticoTiny$result;
