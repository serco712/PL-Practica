...
\begin{math}
   ...
   % declaracion \longrightarrow \textbf{type}\;\textbf{struct}\;\{\;lista$-$variables\;\}\;\textbf{identificador}\\
    ...
    | \hspace{1cm}E5.\textbf{a} \;= \textbf{exp$\_$menos}(E6.\textbf{a})\\
    E5 \longrightarrow not\;E6\\
    | \hspace{1cm}E5.\textbf{a} \;= \textbf{exp$\_$not}(E6.\textbf{a})\\
    E5 \longrightarrow E6\\
    ...
    | \hspace{1cm}E6.\textbf{a} \;= \textbf{exp$\_$reg}(\textbf{identificador.lex})\\  
