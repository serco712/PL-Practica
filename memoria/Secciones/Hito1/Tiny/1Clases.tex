...
\begin{itemize}
    ...
    \item \textbf{Corchete asignación tamaño de apertura.} Se representa con el símbolo del corchete de apertura ([). Su clase léxica será \textit{corcheteTamAp}.
    \item \textbf{Corchete asignación tamaño de cierre.} Se representa con el símbolo del corchete de cierre (]). Su clase léxica será \textit{corcheteTamCi}.
