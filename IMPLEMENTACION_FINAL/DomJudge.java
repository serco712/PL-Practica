...
public class DomJudge {
   public static void main(String[] args) throws Exception {
	   try {
	        Reader input = new InputStreamReader(new FileInputStream("/Users/lijie/Documents/GitHub/TFG-2324-Sivaria/PL-Practica/PROYECTO_FINAL/casos_prueba_correctos/casos_basicos/04control_d.in"));
